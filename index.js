...
const eventJson = [
{
    cron: "50 9 * * 1,2,3,4,5,6,7",
    msg: {
      title: "Відключення сервера!",
      desc: "Через 10 хв. відключення серверу.",
      color: "#FD0061",
    },
  },
{
    cron: "55 9 * * 1,2,3,4,5,6,7",
    msg: {
      title: "Відключення сервера!",
      desc: "Через 5 хв. відключення серверу.",
      color: "#FD0061",
    },
  },

{
    cron: "00 10 * * 1,2,3,4,5,6,7",
    msg: {
      title: "Сервера відключені!",
      desc: "Зараз буде апдейт гри, але патчноутів нема.",
      color: "#FD0061",
    },
  },
  // Daily reset
